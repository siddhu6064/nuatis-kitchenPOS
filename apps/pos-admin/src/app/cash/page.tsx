  ...
  return (
    <DashboardShell>
      <div className="max-w-5xl mx-auto">
        <h1 className="font-serif text-3xl font-bold text-slate-900 mb-2">Cash Drawer</h1>
        <ComingSoon
          icon={<Banknote className="h-12 w-12 text-slate-300" />}
          title="Cash drawer management coming soon"
          description="This screen will show cash drawer events, opening/closing balances, and variance reports for each shift."
        />
      </div>
    </DashboardShell>
  );
